...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname cs1101A21Day18before) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;#lang racket
...
;	• That filter and map provides a compact way to write certain functions over lists 
...
; ;; extract-positives:  ListOfNumber -> ListOfNumber
; ;; produces a list of only the positive numbers
 (define (extract-positives--filter alon)
...
(define LINER   (make-boat "Titanic" 1000 25));not beastly (1000)
