...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname Montana-G-Lui-B-hw3-1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;Brandon Lui blui
...
(check-expect (cost-with-tip--menu-item (make-menu-item "DOg Diggedy Dog" "entree" true 1 0) 10)
              0)
(check-expect (cost-with-tip--menu-item (make-menu-item "Meep" "appetizer" true 0 8.50) 10)
              0)
...
(check-expect (cost-with-tip--menu-item (make-menu-item "Drink" "beverage" true 1 8.50) 20)
              8.5)
(check-expect (cost-with-tip--menu-item (make-menu-item "McBurger" "beverage" true 1 5) 100)
              5)
(check-expect (cost-with-tip--menu-item (make-menu-item "silly" "entree" true 1 5) 100)
              10)
